    ...
    <div className="container py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          I create Minecraft plugins that focus on performance,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="bg-card p-6 rounded-lg border border-border">
          ...
          <h3 className="text-xl font-semibold mb-2">Quality Plugins</h3>
          <p className="text-muted-foreground">
            Carefully crafted plugins available for anyone to use.
          </p>
        </div>
        ...
        <div className="bg-card p-6 rounded-lg border border-border">
          ...
          <p className="text-muted-foreground">
            Constantly improving plugins to ensure compatibility with the latest Minecraft versions.
          </p>
        </div>
      </div>
    </div>
